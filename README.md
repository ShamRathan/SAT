...
```
Find a positive real root of 𝒙**𝟑 − 𝒙 − 𝟐 = 𝟎 using Newton-Raphson method. 
...
```
#Solve the system of equations 𝟒𝒙 + 𝒚 + 𝒛 = 𝟏; 𝒙 + 𝟑𝒚 + 𝒛 = 𝟐; 𝒙 + 𝒚 + 𝟓𝒛 = 𝟑, using Gauss-Seidel method. 
...
```
#Evaluate ∫(𝒅𝒙/1+𝒙**𝟐) [upperlimit=1;lowerlimit=0]using trapezoidal rule with 𝒉 = 𝟎. 𝟐.
def f(x):
 return 1/(1+x**2)
...
```
#Find 𝒚(𝟎. 𝟐), given that 𝒅𝒚/𝒅𝒙= 𝒙 + 𝒚**𝟐, 𝒚(𝟎) = 𝟏 using Runge-Kutta fourth order method.
def f (x, y):
 return x+y**2
...
```
#Evaluate (𝟏. 𝟒) , given that 𝒅𝒚/𝒅𝒙= 𝒙**𝟐(𝟏 + 𝒚), 𝒚(𝟏) = 𝟏, 𝒚(𝟏. 𝟏) = 𝟏. 𝟐𝟑𝟑, 𝒚(𝟏. 𝟐) = 𝟏. 𝟓𝟒𝟖 and 𝒚(𝟏. 𝟑) = 𝟏. 𝟗𝟕𝟗 using Adam’s predictor and corrector method.
def f (x, y):
 return x**2*(1+y)
